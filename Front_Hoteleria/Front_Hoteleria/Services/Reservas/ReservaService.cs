...
namespace Front_Hoteleria.Services.Reserva
{
    public class ReservaService : IReservaService
    {
        ...
        public async Task<List<ReservaDto>> HabitacionesDisponiblesAsync(int vigencia, string bearer = null)
        {
            try
            {
                SetBearer(bearer);
        ...
        public async Task<ReservaDashboardDto> DashboardHabitacionAsync(DateTime? desde, DateTime? hasta, string bearer = null)
        {
            try
            {
                SetBearer(bearer);
        ...
        public async Task<bool> CrearHabitacionAsync(ReservaDto dto, string bearer = null)
        {
            try
            {
                SetBearer(bearer);
        ...
        public async Task<bool> ConfirmarHabitacionAsync(ReservaDto dto, string bearer = null)
        {
            try
            {
                SetBearer(bearer);
        ...
        public async Task<bool> ModificarHabitacionAsync(ReservaDto dto, string bearer = null)
        {
            try
            {
                SetBearer(bearer);
