...
namespace Front_Hoteleria.Controllers
{
    public class ServiciosPersonalController : Controller
    {
        ...
        public ServiciosPersonalController() : this(new ServicioPersonalService()) { }
        public ServiciosPersonalController(IServiciosPersonalService api) { _api = api; }
