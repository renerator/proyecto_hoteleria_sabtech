...
namespace Front_Hoteleria.Controllers
{
    public class ServiciosDisponiblesController : Controller
    {
        ...
        public ServiciosDisponiblesController(IServicioService api) { _api = api; }
        ...
        public async Task<ActionResult> Tabla(int? estado)
        {
            ...
            var lista = await _api.ListarServiciosAsync(1, token) ?? new List<ServicioDto>();
        ...
        {
            return PartialView("~/Views/ServiciosDisponibles/_PanelesServicioDisponibles.cshtml");
        }

        [HttpGet]
        public ActionResult Dashboard()
        {
            return PartialView("~/Views/ServiciosDisponibles/_DashboardServicioDisponibles.cshtml");
        }
        ...
        public ActionResult Upsert(int? id)
        {
            ...
            return PartialView("~/Views/ServiciosDisponibles/_UpsertServicioDisponibles.cshtml", model);
        }
