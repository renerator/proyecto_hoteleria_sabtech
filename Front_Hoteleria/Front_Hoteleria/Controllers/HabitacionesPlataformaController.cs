...
{
    public class HabitacionesPlataformaController : Controller
    {
        private readonly IHabitacionService _api;
        private readonly IHabitacionInsumoService _habInsumoApi;

        // ----- DI (recomendado) -----
        public HabitacionesPlataformaController(IHabitacionService api, IHabitacionInsumoService habInsumoApi)
        {
        ...
        public HabitacionesPlataformaController() : this(new HabitacionService(), new HabitacionInsumoService()) { }
            ...
            try
            {
                ...
                switch (perfil)
                {
                    ...
                    case 4:
                        ...
                        return View("~/Views/HabitacionesPlataforma/Index.cshtml");
