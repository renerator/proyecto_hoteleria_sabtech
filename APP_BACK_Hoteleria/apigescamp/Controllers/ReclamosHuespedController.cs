...
namespace DemoBackend.Controllers
{
    ...
    [Authorize]
    public class ReclamosHuespedController : BaseController
    {
        private readonly IReservaService _reservaService;
        private readonly ILogger _logger;

        public ReclamosHuespedController(IReservaService reservaService, ILogger<ReservasController> logger)
        {
            _logger = logger;
